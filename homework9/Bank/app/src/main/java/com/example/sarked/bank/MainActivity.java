...
//        banks.add(mtb);
        ...
        final Button val1 = (Button) findViewById(R.id.btn_from);
        final Button ft = (Button) findViewById(R.id.from_to);
        final Button val2 = (Button) findViewById(R.id.btn_to);
        ...
        input.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if (input.getText().toString().equals("")) {
                    ...
                    Toast .makeText(MainActivity.this, "Да введите же что-нибудь!",Toast.LENGTH_LONG).show();
                }else{
...
//                    Iterator<Bank>iter=banks.iterator();
                    ...
                    if(val1.getText()==val2.getText()||val1.getText()=="Валюта А"||val2.getText()=="Валюта Б"){
                        Toast .makeText(MainActivity.this, "Выберите разные валюты",Toast.LENGTH_LONG).show();
                    }else{
                        switch (vala){
