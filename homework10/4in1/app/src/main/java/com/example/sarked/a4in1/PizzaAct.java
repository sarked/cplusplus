...
public class PizzaAct extends AppCompatActivity {
    private PizzaAct self;
...
//                                    layer1.setOrientation(LinearLayout.VERTICAL);
...
////
////
////                                    //помещаем элементы в нужные лаяуты: а строку текст
//                                    layer1.addView(ordtxt);
//                                    //в общий вертикальный лайаут строку
//                                    lay.addView(layer1);
//                                    //все строки в подтянутый айаут
//                                    //!!!!!!!: этот код выбрасывает ошибку
