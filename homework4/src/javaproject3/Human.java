...
public class Human extends Creature{
	...
	public void attack(Creature a) {
		...
		if (a.health<=0) {
			System.out.println(this.name+" берет свой "+weapon.name+" и наносит "+x+" урона по "+a.name+". "+a.name+" ”Ѕ»“!");
			}
			else
			{System.out.println(this.name+" берет свой "+weapon.name+" и наносит "+x+" урона по "+a.name+" оставл€€ ему "+a.health+ " хп!");}
	}
